...
from .additional_info import router as additional_info
...
from .login import create_access_token, create_refresh_token
auth_router = APIRouter()
# 추가정보 입력
auth_router.include_router(additional_info)
